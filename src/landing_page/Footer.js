...
function Footer() {
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          <p>
            ...
            <br />
            <a href="Philosophy">philosphy</a> <br />
            <a href="Press & media">hi</a>
            <br />
            <a href="Careers"hlo></a>
            <a href="">
              <br />
            </a>
      ...
      <div className="mt-5 fs=5 test-muted"> <p>
        {" "}
        ...
        Risk Disclosure Document as prescribed by SEBI | ICF Procedure to file a
        complaint on SEBI SCORES: Register on SCORES portal. Mandatory details
      ...
      <p>
        ...
        Update your e-mail and phone number with your stock broker / depository
